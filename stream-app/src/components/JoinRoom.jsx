        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            ...
            <div className="max-w-xl lg:max-w-lg">
              ...
              {showWelcome && (
                <div className="mt-4 text-green-400 font-bold animate-pulse">Welcome! Joining room...</div>
              )}
            </div>
            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div className="flex flex-col items-start">
                ...
                <dd className="mt-2 text-base text-gray-400">Non laboris consequat cupidatat laborum magna. Eiusmod non irure cupidatat duis commodo amet.</dd>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <dd className="mt-2 text-base text-gray-400">Officia excepteur ullamco ut sint duis proident non adipisicing. Voluptate incididunt anim.</dd>
              </div>
            </dl>
