...
const FAQ = () => {
    return (
        <div className='bg-[linear-gradient(to_top_right,_rgba(250,250,250,1)_0%,_rgba(217,217,217,1)_50%)] py-24'>
        <div className="max-w-2xl mx-auto  ">
            <div className="space-y-4">
                <h1 className='text-3xl font-bold text-center my-20'>Frequently Asked Questions</h1>
